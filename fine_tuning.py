...
def main(saving_folder_name=None, criterion='BCELoss', small_dataset=False, use_gpu=True, project_name='test', max_days=7, pred_window=1, BATCH_SIZE=128, LR=0.0001, min_frequency=1, hidden_size=128, num_epochs=50):
    # define the device
    if use_gpu:
