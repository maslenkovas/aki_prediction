...
#      use_gpu=False, project_name='Fixed_obs_window_model', pred_window=2, BATCH_SIZE=128, LR=1e-05,\
...
# 34232, 34271 with new tokenizer
# main(saving_folder_name=None, criterion='BCELoss', small_dataset=False,\
#      use_gpu=False, project_name='Fixed_obs_window_model', pred_window=2, BATCH_SIZE=1024  , LR=1e-05,\
#          min_frequency=3, hidden_size=128, num_epochs=100, wandb_mode='online', PRETRAINED_PATH=None, run_id=None)


# # 34284 weight_decay=0.01
# main(saving_folder_name=None, criterion='BCELoss', small_dataset=False,\
#      use_gpu=False, project_name='Fixed_obs_window_model', pred_window=2, weight_decay=0.01, BATCH_SIZE=1024  , LR=1e-05,\
#          min_frequency=3, hidden_size=128, num_epochs=100, wandb_mode='online', PRETRAINED_PATH=None, run_id=None)


# # 34285 weight_decay=0.1
# main(saving_folder_name=None, criterion='BCELoss', small_dataset=False,\
#      use_gpu=False, project_name='Fixed_obs_window_model', pred_window=2, weight_decay=0.1, BATCH_SIZE=1024  , LR=1e-05,\
#          min_frequency=3, hidden_size=128, num_epochs=100, wandb_mode='online', PRETRAINED_PATH=None, run_id=None)

# # 34287 weight_decay=0.1, min_frequency=5
# main(saving_folder_name=None, criterion='BCELoss', small_dataset=False,\
#      use_gpu=False, project_name='Fixed_obs_window_model', pred_window=2, weight_decay=0.1, BATCH_SIZE=1024  , LR=1e-05,\
#          min_frequency=5, hidden_size=128, num_epochs=100, wandb_mode='online', PRETRAINED_PATH=None, run_id=None)
...
# # 34476:  weight_decay=0.1, min_frequency=5
# main(saving_folder_name=None, criterion='BCEWithLogitsLoss', small_dataset=False,\
#      use_gpu=True, project_name='Fixed_obs_window_model', pred_window=2, weight_decay=0.1, BATCH_SIZE=1024  , LR=1e-05,\
#          min_frequency=5, hidden_size=128, num_epochs=100, wandb_mode='online', PRETRAINED_PATH=None, run_id=None)

# ## 34477: weight_decay=0.01, min_frequency=5
# main(saving_folder_name=None, criterion='BCELoss', small_dataset=False,\
#      use_gpu=True, project_name='Fixed_obs_window_model', pred_window=2, weight_decay=0.01, BATCH_SIZE=1024  , LR=1e-05,\
#          min_frequency=5, hidden_size=128, num_epochs=100, wandb_mode='online', PRETRAINED_PATH=None, run_id=None)

# ## 34503: weight_decay=0, min_frequency=5, drop=0.6
# main(saving_folder_name=None, criterion='BCEWithLogitsLoss', small_dataset=False,\
#      use_gpu=True, project_name='Fixed_obs_window_model', pred_window=2, weight_decay=0, BATCH_SIZE=1024  , LR=1e-05,\
#          min_frequency=5, hidden_size=128, drop=0.6, num_epochs=100, wandb_mode='online', PRETRAINED_PATH=None, run_id=None)

## 34518: weight_decay=0, min_frequency=5, drop=0.4
main(saving_folder_name=None, criterion='BCEWithLogitsLoss', small_dataset=False,\
     use_gpu=True, project_name='Fixed_obs_window_model', pred_window=2, weight_decay=0, BATCH_SIZE=1024  , LR=1e-05,\
         min_frequency=5, hidden_size=128, drop=0.4, num_epochs=100, wandb_mode='online', PRETRAINED_PATH=None, run_id=None)