...
#             pred_window=2, observing_window=2, BATCH_SIZE=16, LR=0.0001, min_frequency=5, hidden_size=128,\
#                 drop=0.6, embedding_size=200, weight_decay=0, num_epochs=1, wandb_mode='disabled', PRETRAINED_PATH=None, run_id=None)

# 
main(saving_folder_name=None, additional_name=args.additional_name, criterion='BCELoss', \
    use_gpu=False, project_name='ICU_lstm_model', experiment='model_1', oversampling=False, 
            pred_window=2, observing_window=2, BATCH_SIZE=512, LR=args.lr, min_frequency=5, hidden_size=128,\
                drop=args.drop, embedding_size=args.embedding_size, weight_decay=0, num_epochs=100, wandb_mode='online', PRETRAINED_PATH=None, run_id=None)